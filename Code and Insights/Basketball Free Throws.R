...
rownames(FreeThrowsAttempts)<- Players#Bind the given vectors to form the matrix
#Remove vectors - we don't need them anymore
#Rename the columns
...
myplot <- function(z, who=1:10) 
  {
    ...
    legend(x="bottomleft",inset=0.01, legend=Players[who], col=c(1:4,2), cex=0.75, pch=15:18, horiz=F)
  }
